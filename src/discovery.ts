...
export const ENDPOINTS: Endpoint[] = [
  ...
  },
  {
    ...
    description: "DEPLOYER TRUST SCORE (0-100) for a Base address: derived from our own graded track_record.jsonl -- rug rate vs our base rate, relauncher flag, elapsed-time avg time-to-rug, and confidence by sample size. Bots calling this skip building a deployer tracker plus the multi-month track record; the score is only meaningful because we grade tokens in public over elapsed time. Address validated pre-paywall (400, never a charge).",
    input: {
    ...
    output_example: {
      ...
      n: 4,
      confidence: "medium",
      disclaimer: "Score is relative to our base rate; low n inflates confidence interval.",
    },
  },
];
